...
class CategoryController extends Controller
{
    ...
    {
        $admins = Category::get();
        return view('vendor.subjects.index',compact('admins'));
    }
    ...
    {
        return view('vendor.subjects.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('vendor.subjects.show',compact('subject'));
    }
    ...
    {
        $subject = Category::find($id);
        return view('vendor.subjects.edit',compact('subject'));
    }
    ...
    public function categoryImage($id)
    {
        ...
        return view('vendor.subjects.showImages', compact('images','cat'));
    }

    public function categoryAddImage($id)
    {
        $cat = Category::find($id);
        return view('vendor.subjects.createimg', compact('cat'));
    }
