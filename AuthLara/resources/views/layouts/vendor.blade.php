...
<body data-topbar="dark" data-layout="horizontal">
            ...
            <div class="navbar-header">
                ...
                <div class="d-flex  pt-1">
                    ...
                    <div class="dropdown d-none d-lg-inline-block">
                        <button type="button" class="btn header-item toggle-search  waves-effect"
    ...
    <div data-simplebar class="h-100"> --}}
        ...
        @if ($errors->any())
            <center>
                <div class="col-sm-12 btn btn-success">{{ implode('', $errors->all()) }}</div>
            </center>
        @endif
                ...
                <div class="" style="margin-top:50px">
                    ...
                    <div class="categories bg-white h-100 px-2 pt-1 pb-1 cat-itm mx-auto main-cat  main-section">
                        <div class="categories-cont d-inline-flex">
                            <a type=""href="/general"
                                class="d-inline-block pt-1 w-100 h-100 text-center text-dark mx-1">
                                <img src="{{ url('assets/admin/images/general-ads.jpg') }}" alt=""
                            ...
                            <a type=""href="/cars"
                                class="d-inline-block pt-1 h-100 text-center text-dark mx-1">
                            ...
                            <a type=""
                                href="/stores"class="d-inline-block pt-1 w-100 h-100 text-center text-dark mx-1">
                            ...
                            <a type=""
                                href="/homes"class="d-inline-block pt-1 w-100 h-100 text-center text-dark mx-1">
                                <img src="{{ url('assets/admin/images/estates.jpg') }}" alt=""
                                    width="100%" height="90%"><br>
                                <span class="category-nm d-inline-block">شقق</span>
                            </a>

                            <a type=""
                                href="/mobiles"class="d-inline-block pt-1 w-100 h-100 text-center text-dark mx-1">
                                <img src="{{ url('assets/admin/images/mobiles.jpg') }}" alt=""
                                    width="100%" height="90%"><br>
                        ...
                        <div class="col-6 col-md-4 col-lg-4 mb-4 mb-lg-1 linkColor">
                            ...
                            <div class="row">
                                <div class="col-sm-6 text-left">
                                    ...
                                    <a href="/" class="link h6 d-block text-light ">اعلانات المحلات و المكاتب
                                    </a>
                        ...
                        <div class="col-6 col-md-4 col-lg-4">
                            ...
                            <div class="Download-Icons">
                                <a href="https://vm.tiktok.com/ZMR5jhvbA/" class="h3 text-primary mr-1"><img
                                        src="https://autobazar.souqeljuma.com/assets/site/images/tiktok.png"
