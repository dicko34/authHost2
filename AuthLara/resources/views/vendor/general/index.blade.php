            ...
            <div class="body-card m-3">
                <div class="row">
                    ...
                    <div class="col-6 text-right">
                        <a class="btn btn-primary w-md waves-effect waves-light" href="{{ route('general.add') }}">أضافة
                            أعلان هنا</a>
                    </div>
                </div>
                <div class="row">
                    ...
                    @foreach ($generals as $general)
                        <div class="col-6 col-xl-2 p-1">
                            <div class="card">
                                <a href="{{ url('assets/site/images/general/' . explode(',', $general->img)[0]) }}"
                                    class="gallery-popup" style="height: 160px; width:100%">
                                    <div class="project-item">
                                        <div class="overlay-container">
                                            <img src="{{ url('assets/site/images/general/' . explode(',', $general->img)[0]) }}"
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">{{ $general->city }} {{ $general->address }} للبيع في
                                        {{ $general->model }} اعلان</p>
                                </div>
                            </div>
                        </div>
                    @endforeach
