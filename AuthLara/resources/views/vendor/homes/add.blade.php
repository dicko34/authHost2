...
@section('content')
    ...
    <form method="POST" action="{{ route('vendor.homes.store') }}" enctype="multipart/form-data">
        @csrf
        @if ($errors->any())
        ...
        <div class="add-section w-75 mx-auto bg-white">
            ...
            <table class="table table-bordered table-striped mb-0">
                <tbody>
                    <tr>
                        ...
                        <td>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" required="" type="radio" name="show"
                                    id="offer_type_sell" value="للبيع">
                                <label class="form-check-label" for="offer_type_sell">للبيع</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="show" id="offer_type_rent"
                                    value="للايجار">
                    ...
                    <tr>
                        <td>نوع العقار <span class="text-danger" style="font-weight: 700;">*</span> </td>
                        <td>
                            <select name="home_type" class="form-select form-select-sm" required="" type="text">
                    ...
                    <tr>
                        <td>الحالة <span class="text-danger" style="font-weight: 700;">*</span> </td>
                        <td>
                            <select name="status" class="form-select form-select-sm" required="" type="text">
                    ...
                    <tr>
                        <td>عدد الغرف <span class="text-danger" style="font-weight: 700;">*</span> </td>
                        <td>
                            <select name="rooms_number" class="form-select form-select-sm" required="" type="text">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="input-group input-group-sm">
                                <input type="number" class="form-control " name="bathrooms_number"
                                    placeholder="عدد الحمامات" aria-label="عدد الحمامات" aria-describedby="basic-addon2">
                                <span class="input-group-text" id="basic-addon2">كم حمام؟</span>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div class="input-group input-group-sm">
                                <input type="number" class="form-control " name="kitchen_number" placeholder="عدد المطابخ"
                                    aria-label="عدد المطابخ" aria-describedby="basic-addon2">
                                <span class="input-group-text" id="basic-addon2">كم مطبخ؟</span>
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="input-group input-group-sm">
                                <input type="text" class="form-control " name="loung" placeholder="هل يوجد صالة؟"
                                    aria-label="هل يوجد صالة؟" aria-describedby="basic-addon2">
                                <span class="input-group-text" id="basic-addon2">مثال: صالة كبيرة</span>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div class="input-group input-group-sm">
                                <input type="number" class="form-control " name="land_area"
                                    placeholder="مساحة الأرض المقام عليها البناء"
                                    aria-label="مساحة الأرض المقام عليها البناء" aria-describedby="basic-addon2">
                                <span class="input-group-text" id="basic-addon2">متر مربع</span>
                            </div>
                        </td>
                    </tr>
