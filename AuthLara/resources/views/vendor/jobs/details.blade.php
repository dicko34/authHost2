                    ...
                    <div class="float-left text-dark border-right px-2 py-1" style="font-size: 14px;">
                        ...
                        <ul class="d-inline-flex mb-0">
                            <li class="f-right px-2 py-1" style="font-size: 14px;">
                                <a onclick="window.open('https://www.facebook.com/sharer/sharer.php?u=https://www.wenak.ps/car/{{ $job->id }}.html&amp;src=sdkpreparse','newwindow','width=300,height=250'); return false;"
                                    style="color: #888"><i class="fab fa-facebook-square" style="font-size: 18px;"></i></a>
                            </li>
                            <li class="f-right px-2 py-1" style="font-size: 14px;">
                                <a onclick="window.open('https://twitter.com/intent/tweet?text=https://www.wenak.ps/job/{{ $job->id }}.html&amp;src=sdkpreparse','newwindow','width=300,height=250'); return false;"
                                    style="color: #888"><i class="fab fa-twitter" style="font-size: 18px;"></i></a>
                            </li>
                            <li class="f-right px-2 py-1" style="font-size: 14px;">
                                <a onclick="window.open('https://api.whatsapp.com/send?text=https://www.wenak.ps/job/{{ $job->id }}.html','newwindow','width=1200,height=450'); return false;"
                                    style="color: #888"><i class="fab fa-whatsapp" aria-hidden="true"
                                        style="font-size: 18px;"></i></a>
                            </li>
                            <li class="f-right px-2 py-1" style="font-size: 14px;">
                                <a onclick="window.open('https://mail.google.com/mail/?view=cm&amp;fs=1&amp;tf=1&amp;to=&amp;su=وينك من زمان - سيات | SEAT ابيزا 2009&amp;body=سيات | SEAT ابيزا 2009 https://www.wenak.ps/job/{{ $job->id }}.html&amp;ui=2&amp;tf=1&amp;pli=','newwindow','width=1200,height=450'); return false;"
                            ...
                            <div class="media h-100" style="width: 100%;">
                                <div style="position: relative" class="h-100">
                                    <img class="first-img img-fluid"
                                        src="{{ url('assets/site/images/jobs/' . explode(',', $job->img)[0]) }}"
                                        alt="{{ $job->specialization }} | {{ $job->workplace }}"
                                        title="{{ $job->specialization }} | {{ $job->workplace }}"
                                ...
                                <div class="media-body px-3 pt-1" style="">
                                    ...
                                    <h5 class="mt-2 title " style="    font-size: 1.1rem;font-family:Tajawal">
                                        {{ $job->specialization }} | {{ $job->workplace }}</h5>
                                    <li class="old-price not-cut d-block d-lg-none">{{ $job->price }}</li>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row details" style="padding: 0;margin-right: 0px;margin-left: 0px;">
                        ...
                        <div style="    padding: 20px;
                            ...
                            <div class="row " style="min-height: 83px;margin-right: 0px;margin-left: 0px;">
                                <div class="col text-center">
                                    ...
                                    <table class="table table-sm">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>رقم الموبايل</td>
                                                <td><a class="text-dark" href="tel:{{ $job->mobile }}"> {{ $job->mobile }}
                                                    </a></td>
                                                </td>
                                            </tr>
                                        </tbody>
                                ...
                                <div class="card-footer w-100 mt-3 d-block d-lg-none">
                                    <a href="javascript:ReportModal({{ $job->id }});">هل وجدت خطأ في الاعلان ؟</a>
                                    <p>رقم الاعلان : {{ $job->id }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-12 text-center mt-3">
                                <table class="table table-striped table-sm">
                                    <tbody style="font-weight:500">
                                        ...
                                        <tr>
                                            <td><a dir="ltr" href="tel:{{ $job->mobile }}" style="font-size: 20px;"> {{ $job->mobile }} </a>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                    ...
                    <div class="col-sm-12 col-lg-8 col-xl-9 " style="padding: 13px;">
                        ...
                        <div class="d-none d-lg-block">
                            <div class="row mb-20px">
                                <div class="col-xl-12 col-md-12" style="line-height: 28px;">
                                    <span> التخصص :</span> {{ $job->specialization }}
                                </div>
    
                                <div class="col-xl-12 col-md-12" style="line-height: 28px;">
                                    <span> مكان العمل :</span> {{ $job->workplace }}
                                </div>
    
                                <div class="col-xl-12 col-md-12" style="line-height: 28px;">
                                    <span>الدوام:</span> {{ $job->permanence }}
                                </div>
                                ...
                                <div class="col-xl-12 col-md-12" style="line-height: 28px;">
                                    <span> معلومات اخرى :</span> <pre>{{ $job->description }}</pre> 
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4 col-xl-3 border-right border-md-top d-none d-lg-block d-xl-block" style="min-height: 230px;background-color: #fff;">
                        ...
                        <div class="col-md-12 text-center mt-1">
                            <b style="color: #ff9800 ;font-size: 20px;" class="text-dark">{{$job->advertiser_name}}</b>
                        </div>
                        <div class="col-md-12 text-center mt-3">
                            <table class="table table-sm">
                                <tbody>
                                        ...
                                        <div class="overlay-container">
                                            ...
                                            <div class="project-item-overlay text-right">
                                                ...
                                                <p>
                                                    ...
                                                    <span class="ml-2">{{ $job_similar['advertiser_name'] }}</span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
