    ...
    <div class="w-100 mx-auto bg-white" style="max-width:980px;">
                    ...
                    <div class="float-left text-dark border-right px-2 py-1" style="font-size: 14px;">
                        ...
                        <ul class="d-inline-flex mb-0">
                            <li class="f-right px-2 py-1" style="font-size: 14px;">
                                <a onclick="window.open('https://www.facebook.com/sharer/sharer.php?u=https://www.wenak.ps/car/{{ $mobile->id }}.html&amp;src=sdkpreparse','newwindow','width=300,height=250'); return false;"
                                    style="color: #888"><i class="fab fa-facebook-square" style="font-size: 18px;"></i></a>
                            </li>
                            <li class="f-right px-2 py-1" style="font-size: 14px;">
                                <a onclick="window.open('https://twitter.com/intent/tweet?text=https://www.wenak.ps/car/{{ $mobile->id }}.html&amp;src=sdkpreparse','newwindow','width=300,height=250'); return false;"
                                    style="color: #888"><i class="fab fa-twitter" style="font-size: 18px;"></i></a>
                            </li>
                            <li class="f-right px-2 py-1" style="font-size: 14px;">
                                <a onclick="window.open('https://api.whatsapp.com/send?text=https://www.wenak.ps/car/{{ $mobile->id }}.html','newwindow','width=1200,height=450'); return false;"
                                    style="color: #888"><i class="fab fa-whatsapp" aria-hidden="true"
                                        style="font-size: 18px;"></i></a>
                            </li>
                            <li class="f-right px-2 py-1" style="font-size: 14px;">
                                <a onclick="window.open('https://mail.google.com/mail/?view=cm&amp;fs=1&amp;tf=1&amp;to=&amp;su=وينك من زمان - سيات | SEAT ابيزا 2009&amp;body=سيات | SEAT ابيزا 2009 https://www.wenak.ps/car/{{ $mobile->id }}.html&amp;ui=2&amp;tf=1&amp;pli=','newwindow','width=1200,height=450'); return false;"
                            ...
                            <div class="media h-100" style="width: 100%;">
                                <div style="position: relative" class="h-100">
                                    <img class="first-img img-fluid"
                                        src="{{ url('assets/site/images/mobiles/' . explode(',', $mobile->img)[0]) }}"
        ...
        <div class="w-100">
                    ...
                    <div style="    padding: 20px;
                        ...
                        <div class="row " style="min-height: 83px;margin-right: 0px;margin-left: 0px;">
                            <div class="col text-center">
                                ...
                                <table class="table table-sm">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>رقم الموبايل</td>
                                            <td><a class="text-dark" href="tel:{{$mobile->mobile}}"> {{$mobile->mobile}}
                                                </a></td>
                                            </td>
                                        </tr>
                                    </tbody>
                            ...
                            <div class="card-footer w-100 mt-3 d-block d-lg-none">
                                <a href="javascript:ReportModal({{$mobile->id}});">هل وجدت خطأ في الاعلان ؟</a>
                                <p>رقم الاعلان : {{$mobile->id}}</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-12 text-center mt-3">
                            <table class="table table-striped table-sm">
                                <tbody style="font-weight:500">
                                    ...
                                    <tr>
                                        <td><a dir="ltr" href="tel:{{$mobile->mobile}}" style="font-size: 20px;"> {{$mobile->mobile}} </a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                ...
                --}}
                    ...
                    <div class="col-sm-12 col-lg-8 col-xl-9 " style="padding: 13px;">
                        ...
                        <div class="d-block d-lg-none">
                            <table class="table ">
                                <tbody style="font-weight:500">
                                    ...
                                    <tr>
                                        <td>الحالة</td>
                                        <td>{{ $mobile->device_status }}</td>
                                    </tr>
                                    <tr>
                                        <td>عدد الشرائح</td>
                                        <td>{{ $mobile->slides_number }}</td>
                                    </tr>
                                    <tr>
                                        <td>حجم الشاشة</td>
                        ...
                        <div class="d-none d-lg-block">
                            <div class="row mb-20px">
                                <div class="col-xl-12 col-md-12" style="line-height: 28px;">
                                    <span><i class="fas fa-mobile-alt"></i> الموديل :</span> {{ $mobile->model }}
                                </div>

                                <div class="col-xl-12 col-md-12" style="line-height: 28px;">
                                    <span><i class="fas fa-star"></i> الحالة :</span>{{ $mobile->device_status }}
                                </div>

                                <div class="col-xl-12 col-md-12" style="line-height: 28px;">
                                    <span><i class="fas fa-sliders-h"></i> عدد الشرائح :</span>
                                    {{ $mobile->slides_number }}
                                </div>

                                <div class="col-xl-12 col-md-12" style="line-height: 28px;">
                                    <span><i class="fas fa-tv"></i> حجم الشاشة :</span> {{ $mobile->screen_size }}
                                </div>

                                <div class="col-xl-12 col-md-12" style="line-height: 28px;">
                                    <span><i class="fas fa-camera"></i> الكاميرات :</span> {{ $mobile->cameras }}
                                </div>

                                <div class="col-xl-12 col-md-12" style="line-height: 28px;">
                                    <span><i class="fas fa-memory"></i> الذاكرة :</span> {{ $mobile->memory }}
                                </div>

                                <div class="col-xl-12 col-md-12" style="line-height: 28px;">
                                    <span><i class="fas fa-hdd"></i> التخزين :</span>{{ $mobile->storage }}
                                </div>

                                <div class="col-xl-12 col-md-12" style="line-height: 28px;">
                                    <span><i class="fas fa-map-marker-alt"></i> العنوان :</span> {{ $mobile->address }} -
                                    {{ $mobile->city }}
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col text-center">
                                    ...
                                    <table class="table table-sm">
                                        <tbody>
                                            <tr>
                                                <td>اسم المعلن</td>
                                                <td>{{ $mobile->advertiser_name }}</td>
                                            </tr>
                                            <tr>
                                                <td>رقم الموبايل</td>
                                                <td><a class="text-dark" href="tel:{{ $mobile->mobile }}">
                                                        {{ $mobile->mobile }}
                                                    </a></td>
                                                </td>
                                            </tr>
                    ...
                    <div class="col-md-4 col-xl-3 border-right border-md-top d-none d-lg-block d-xl-block"
                        ...
                        <div class="col-md-12 text-center mt-1">
                            <b style="color: #ff9800 ;font-size: 20px;"
                                class="text-dark">{{ $mobile->advertiser_name }}</b>
                        </div>
                        <div class="col-md-12 text-center mt-3">
                            <table class="table table-sm">
                                <tbody>
                                    ...
                                    <tr>
                                        <td><a dir="ltr" href="tel:{{ $mobile->mobile }}" style="font-size: 20px;">
                                                {{ $mobile->mobile }} </a>
                                        </td>
                                    </tr>
                                </tbody>
            ...
            <div class="w-100 px-1">
                ...
                <div class="row">
                    @foreach ($similar as $mobile_similar)
                        <div class="col-6 col-xl-2 p-1 ">

                            <div
                                class="annonce-item"style="border: 1px solid;border-color: #0000002b;border-radius: 5px;">
                                <a href="{{ url('assets/site/images/mobiles/' . explode(',', $mobile_similar['img'])[0]) }}"
                                    class="gallery-popup" style="height: 160px; width:100%">
                                    <div class="project-item">
                                        <div class="overlay-container">
                                            <img src="{{ url('assets/site/images/mobiles/' . explode(',', $mobile_similar['img'])[0]) }}"
                                            ...
                                            <div class="project-item-overlay text-right">
                                                ...
                                                <p>
                                                    ...
                                                    <span class="ml-2">{{ $mobile_similar['advertiser_name'] }}</span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
