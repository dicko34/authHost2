        ...
        <div class="body-card m-5">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6 col-xl-3">
                    <div class="card">
                        <a href="{{ url('assets/site/images/mobiles/'.explode(',',$mobile->img)[0]) }}" class="gallery-popup" style="height: 230px; width:100%">
                            <div class="project-item">
                                <div class="overlay-container">
                                    <img src="{{ url('assets/site/images/mobiles/'.explode(',',$mobile->img)[0]) }}" alt="img" class="gallery-thumb-img m-0" style="height: 230px; width:100%">
                                    <div class="project-item-overlay text-right">
                                        <h4>موبايل</h4>
                                        <p>
                                            <img src="{{ url('assets/site/images/mobiles/'.explode(',',$mobile->img)[0]) }}" alt="user" class="avatar-xs rounded-circle">
