                ...
                <div class="float-left text-dark border-right px-2 py-1" style="font-size: 14px;">
                    ...
                    <ul class="d-inline-flex mb-0">
                        <li class="f-right px-2 py-1" style="font-size: 14px;">
                            <a onclick="window.open('https://www.facebook.com/sharer/sharer.php?u=https://www.wenak.ps/car/{{$shop->id}}.html&amp;src=sdkpreparse','newwindow','width=300,height=250'); return false;"
                                style="color: #888"><i class="fab fa-facebook-square" style="font-size: 18px;"></i></a>
                        </li>
                        <li class="f-right px-2 py-1" style="font-size: 14px;">
                            <a onclick="window.open('https://twitter.com/intent/tweet?text=https://www.wenak.ps/car/{{$shop->id}}.html&amp;src=sdkpreparse','newwindow','width=300,height=250'); return false;"
                                style="color: #888"><i class="fab fa-twitter" style="font-size: 18px;"></i></a>
                        </li>
                        <li class="f-right px-2 py-1" style="font-size: 14px;">
                            <a onclick="window.open('https://api.whatsapp.com/send?text=https://www.wenak.ps/car/{{$shop->id}}.html','newwindow','width=1200,height=450'); return false;"
                                style="color: #888"><i class="fab fa-whatsapp" aria-hidden="true"
                                    style="font-size: 18px;"></i></a>
                        </li>
                        <li class="f-right px-2 py-1" style="font-size: 14px;">
                            <a onclick="window.open('https://mail.google.com/mail/?view=cm&amp;fs=1&amp;tf=1&amp;to=&amp;su=وينك من زمان - سيات | SEAT ابيزا 2009&amp;body=سيات | SEAT ابيزا 2009 https://www.wenak.ps/car/{{$shop->id}}.html&amp;ui=2&amp;tf=1&amp;pli=','newwindow','width=1200,height=450'); return false;"
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8 col-xl-9" style="padding: 0;height: 110px;">
                        <div class="media h-100" style="width: 100%;">
                            <div style="position: relative" class="h-100">
                                <img class="first-img img-fluid" src="{{ url('assets/site/images/shops/' . explode(',', $shop->img)[0]) }}"
                            ...
                            <div class="media-body px-3 pt-1" style="">
                                <span style="color: #ff9800;  font-size: 13px ;font-weight: 700"><i
                                        class="fas  fa-map-marker-alt" style="    font-size: small;"></i> 

                                    </span>
                                <h5 class="mt-2 title" style="    font-size: 1.1rem;font-family:Tajawal">
                                {{$shop->displayed}} {{$shop->offer}}      
                                </h5>
                                <li class="old-price not-cut d-block d-lg-none">{{$shop->price}} </li>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 border-right-dd border-right ">
                        <div class="">
                            ...
                            <div class="">
                                <ul>
                                    <li class="old-price not-cut d-none d-lg-block" style="font-size: 20px;">{{$shop->price}} </li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row details" style="padding: 0;margin-right: 0px;margin-left: 0px;">
                <div class="col-sm-12 col-lg-8 col-xl-9 " style="padding: 13px;">
                    ...
                    <div class="w-100 px-2 bg-primary">
                        ...
                        style="font-family:Tajawal;line-height:48px;text-align:center;">بيانات المحل</h5>
                    </div>
                    ...
                    <div class="d-none d-lg-block">
                        <div class="row mb-20px">
                            <div class="col-xl-4 col-md-6" style="    line-height: 28px;">
                                <span><i class="fas fa-tags"></i> حاله المحل :</span> {{$shop->status}}
                            </div>
                            <div class="col-xl-4 col-md-6" style="    line-height: 28px;">
                                <span><i class="fas fa-globe"></i> مساحه المحل :</span> {{$shop->address}}
                            </div>
                            <div class="col-xl-4 col-md-6" style="    line-height: 28px;">
                                <span><i class="fas fa-globe"></i> مساحه الارض :</span> {{$shop->address}}
                            </div>
                            <div class="col-xl-12 col-md-12" style="line-height: 28px;">
                                <span><i class="fas fa-compass"></i>العنوان :</span> {{$shop->address}}
                            </div>
                        </div>
                    </div>
                    <br>
                    <div class="w-100 px-2 bg-primary">
                        <h5 class="text-white ml-2 font-weight-bold text-center"style="font-family:Tajawal;line-height:48px;text-align:center;">وصف المحل</h5>
                    </div>
                    ...
                    <div style="    padding: 20px;
                        ...
                        <div class="d-none d-lg-block">
                            <ul>
                                <li style="line-height: 1.3rem !important;">
                                    <pre>
                                       {{$shop->description}}  
                                    </pre>
                        ...
                        <div class="d-block d-lg-none">
                            <table class="table">
                                <tbody style="font-weight:500">
                                    ...
                                    <tr>
                                        <td>
                                            <li style="display: list-item !important;">محل عظم مستقل للبيع والتواصل مع
                                    ...
                                    <tr>
                                        <td>
                                            <li style="display: list-item !important;"> يوجد حديقة منفصلة عن المحل
                                            </li>
                                        </td>
                                    </tr>
                                    <tr>
                    ...
                    <div class="d-none d-lg-block">
                        <div class="row mb-20px" style="line-height: 28px;">
                            <div class="col-xl-6 col-md-6">
                                <span><i class="fas fa-map-marker"></i> العنوان :</span> {{$shop->address}}
                            </div>
                        </div>
                    </div>
                    <br>
                    <div class=" border-md-top border-right d-block d-lg-none d-xl-none pt-2">
                        <div class="row " style="min-height: 83px;margin-right: 0px;margin-left: 0px;">
                            <div class="col text-center">
                                ...
                                <table class="table table-sm">
                                    <tbody>
                                        <tr>
                                            <td>اسم المعلن</td>
                                            <td>{{$shop->advertiser_name}}</td>
                                        </tr>
                                        <tr>
                                            <td>رقم الموبايل</td>
                                            <td><a class="text-dark" href="tel:{{$shop->mobile}}"> {{$shop->mobile}}
                                                </a></td>
                                            </td>
                                        </tr>
                                    </tbody>
                            ...
                            <div class="card-footer w-100 mt-3 d-block d-lg-none">
                                <a href="javascript:ReportModal({{$shop->id}});">هل وجدت خطأ في الاعلان ؟</a>
                                <p>رقم الاعلان : {{$shop->id}}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12 text-center mt-3">
                        <table class="table table-striped table-sm">
                            <tbody style="font-weight:500">
                                ...
                                <tr>
                                    <td><a dir="ltr" href="tel:{{$shop->mobile}}" style="font-size: 20px;"> {{$shop->mobile}} </a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                            ...
                            <div class="overlay-container">
                                ...
                                <div class="project-item-overlay text-right">
                                    ...
                                    <p>
                                        ...
                                        <span class="ml-2">{{ $shop_similar['advertiser_name'] }}</span>
                                    </p>
                                </div>
                            </div>
                        </div>
