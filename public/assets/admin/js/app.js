! function(t) {
    ...
    t("#side-menu").metisMenu(), t("#vertical-menu-btn").on("click", function(e) { e.preventDefault(), t("body").toggleClass("sidebar-enable"), 992 <= t(window).width() ? t("body").toggleClass("vertical-collpsed") : t("body").removeClass("vertical-collpsed") }), t("#sidebar-menu a").each(function() {
...
$(document).ready(function() {
    ...
    $("#datatable").DataTable(), $("#datatable-buttons").DataTable({ lengthChange: !1, buttons: ["copy", "excel", "pdf", "colvis"] }).buttons().container().appendTo("#datatable-buttons_wrapper .col-md-6:eq(0)")
});
...
! function(t) {
    ...
    function a() {}
    a.prototype.init = function() { t(".select2").select2() }, t.AdvancedForm = new a, t.AdvancedForm.Constructor = a
}(window.jQuery),
function() {
    "use strict";
